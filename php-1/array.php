...
$people0 = array("Name"=>"Will Byers", "Age"=>12, "Aliases"=>"Will the Wise", "Status"=> "Alive");
$people1 = array("Name"=>"Mike Wheeler", "Age"=>12, "Aliases"=>"Dungeon Master", "Status"=> "Alive");
$people2 = array("Name"=>"Jim Hopper", "Age"=>43, "Aliases"=> "Chief Hopper", "Status"=> "Deceased");
$people3 = array("Name"=>"Eleven", "Age"=>12, "Aliases"=>"El", "Status"=> "Alive");

echo "<h3>Soal no 3</h3>";
for($i=0; $i<4; $i++){
    echo "[".$i."]"; $file = "people".$i;
    echo "<br>[Name] =>".$$file["Name"];
    echo "<br>[Age] =>".$$file["Age"];
    echo "<br>[Aliases] =>".$$file["Aliases"];
    echo "<br>[Status] =>".$$file["Status"]."<br>";
}
?>
</body>
</html>