...
echo "<br>"; echo "Array sisa baginya adalah: "; 
$mod = array($numbers[0]%5,$numbers[1]%5,$numbers[2]%5,$numbers[3]%5,$numbers[4]%5,$numbers[5]%5);
for ($i=0; $i<=5; $i++){
    echo "<br>$numbers[$i] sisa bagi 5 = $mod[$i]"; 
}
echo "<h3> Soal No 3 Looping Asociative Array </h3>";
/*Soal No 3
Loop Associative Array
Terdapat data items dalam bentuk array dimensi. Buatlah data tersebut ke dalam bentuk Array Asosiatif. 
Setiap item memiliki key yaitu : id, name, price, description, source. Output: 
...
echo "<table>"; //ditampilkan lebih rapi dengan table
for($i=0; $i<count($items); $i++){
    $arrayname = "item".($i+1); //nama-nama array assosiatif = item1, item2, item3, dan item4.
    $$arrayname["id"]= $items[$i][0];
    $$arrayname["name"]= $items[$i][1];
    $$arrayname["price"]= $items[$i][2];
    $$arrayname["description"]= $items[$i][3];
    $$arrayname["source"]= $items[$i][4];
    //PRINT ARRAY ASSOSIATIF YANG BARU SAJA DIBUAT
    echo "<td>Array (";
